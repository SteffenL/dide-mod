...
HRESULT WINAPI wrapper_DirectSoundCaptureCreate(LPCGUID pcGuidDevice, LPDIRECTSOUNDCAPTURE* ppDSC,
                                                LPUNKNOWN pUnkOuter) {
...
HRESULT WINAPI wrapper_DirectSoundCaptureCreate8(LPCGUID pcGuidDevice, LPDIRECTSOUNDCAPTURE8* ppDSC8,
                                                 LPUNKNOWN pUnkOuter) {
    return g_origDllFunctions.DirectSoundCaptureCreate8(pcGuidDevice, ppDSC8, pUnkOuter);
}

HRESULT WINAPI wrapper_DirectSoundFullDuplexCreate(LPCGUID pcGuidCaptureDevice, LPCGUID pcGuidRenderDevice,
...
HRESULT __stdcall wrapper_DllCanUnloadNow() { return g_origDllFunctions.DllCanUnloadNow(); }

HRESULT __stdcall wrapper_DllGetClassObject(REFCLSID rclsid, REFIID riid, LPVOID* ppv) {
